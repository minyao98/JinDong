...
import bwei.com.jingddab.Model.NoticeView;
import bwei.com.jingddab.Presenter.Miaoshaadapter;
import bwei.com.jingddab.R;
import bwei.com.jingddab.XiangqingActivity;

public class MyAdapterggg extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyAdapterggg(Context context, List<GGGBean.DataBean> data , ShouyeBean shouye_bean) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof Jiugongge){
            MyjiugonggeAdapter myjiugongge=new MyjiugonggeAdapter(context,data);
        ...
        if (holder instanceof Tuijian){
            ...
            final List<ShouyeBean.TuijianBean.ListBean> list = shouye_bean.getTuijian().getList();
        ...
        if (holder instanceof Miaosha){
            ...
            final List<ShouyeBean.MiaoshaBean.ListBeanX> miaoshalist = shouye_bean.getMiaosha().getList();
